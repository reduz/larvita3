//
// C++ Interface: serializer_size_compute
//
// Description: 
//
//
...
//
//
#ifndef SERIALIZER_SIZE_COMPUTE_H
#define SERIALIZER_SIZE_COMPUTE_H
...
*/
class SerializerSizeCompute : public Serializer {

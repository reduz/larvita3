...
//
//
#ifndef ELLIPSOID_VOLUME_H
#define ELLIPSOID_VOLUME_H
...
/**
	@author ,,, <red@lunatea>
 */
class EllipsoidVolume : public Volume {

	IAPI_TYPE(EllipsoidVolume,Volume);
	Vector3 radius;
...
public:
	...
	virtual Type get_volume_type() const { return ELLIPSOID; }
	...
	EllipsoidVolume(Vector3 p_radius=Vector3(1.0,1.0,1.0));	
	~EllipsoidVolume();
